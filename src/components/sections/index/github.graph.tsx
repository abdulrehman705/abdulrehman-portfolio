        ...
        <section className={`${styles.area}`}>
          <div className={styles.company}>
            <div className={` w-full space-y-6 pb-18 pt-100 md:space-y-12`}>
              ...
              <div className="p-4 w-full md:p-6 flex justify-center items-center overflow-hidden rounded-md border-2 border-opacity-60 border-gray-700 transition-all hover:border-primary-900">
